...
#define CCSV_ARENA_INFINITE_NODES 0U
#define CCSV_ARENA_MINIMUM_SIZE   1024U
...
void  CCSV_Arena_init         (struct CCSV_Arena*, unsigned node_max, const char *name);
bool  CCSV_Arena_create_node  (struct CCSV_Arena*, unsigned size);
void  CCSV_Arena_free         (struct CCSV_Arena*);
void  CCSV_Arena_reset        (struct CCSV_Arena*);
void *CCSV_Arena_alloc_objects(struct CCSV_Arena*, unsigned count, unsigned size, unsigned alignment);
void *CCSV_Arena_alloc        (struct CCSV_Arena*, unsigned size, unsigned alignment);
bool  CCSV_Arena_reserve      (struct CCSV_Arena*, unsigned size, unsigned alignment);
char *CCSV_Arena_strdup       (struct CCSV_Arena*, const char *str, unsigned *length);
